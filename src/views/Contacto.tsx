      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main id='DeterMain'>
          ...
          <section className="flex flex-col md:flex-row justify-center items-center max-w-6xl md:max-w-full mx-auto p-8 gap-8">
            <img
              src="https://w.wallhaven.cc/full/5y/wallhaven-5ydek7.jpg"
              alt="Contáctanos"
            ...
            <div className="w-full md:w-2/5">
              ...
              <div className="grid grid-cols-3 gap-4 m-10">
                <a href="#" className="bg-blue-100 hover:bg-blue-200 rounded-lg p-4 text-center">
                  <i className=" text-2xl text-blue-600">
                    <Icon path={mdiFacebook}></Icon>
                  </i>
                  <p className="mt-2 text-md text-blue-800">Facebook</p>
                </a>
                <a href="#" className="bg-pink-100 hover:bg-pink-200 rounded-lg p-4 text-center">
                  <i className=" text-2xl text-bubblegum">
                    <Icon path={mdiInstagram}></Icon>
                  </i>
                  <p className="mt-2 text-md text-pink-700">Instagram</p>
                </a>
                <a href="#" className="bg-green-100 hover:bg-green-200 rounded-lg p-4 text-center">
                  ...
                  <p className="mt-2 text-md text-green-700">Whatsapp</p>
                </a>
              </div>
            </div>
          </section>
